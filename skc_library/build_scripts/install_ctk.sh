...
CTK_REPO="https://gitlab.devtools.intel.com/sst/isecl/crypto-api-toolkit.git"
...
check_prerequisites()
{
        ...
        if [ ! -f /opt/intel/sgxssl/include/sgx_tsgxssl.edl ]; then
                echo "sgx ssl is required for building cryptokit."
                exit 1
        fi
}
